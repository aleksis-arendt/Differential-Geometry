...
\end{problem}
\begin{problem}
     Let $\gamma: \mathbb{R} \rightarrow \mathbb{T}^2$ be the curve of Example 4.20. Show that the image set $\gamma(\mathbb{R})$ is dense in $\mathbb{T}^2$. (Used on pp. 502, 542.)
\end{problem}
\begin{problem}
